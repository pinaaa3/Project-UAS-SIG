    ...
    <div class="container mt-4 mb-4">
        <div class="bg-white rounded shadow-lg overflow-hidden">
            ...
            <div class="p-4 pb-0 text-center">
                <h1 class="font-bold text-primary">Peta Tematik Kepadatan Penduduk Sulawesi Tengah</h1>
                <p class="text-purple-100 mt-2">Visualisasi kepadatan penduduk per kabupaten/kota di Sulawesi Tengah</p>
            </div>
    ...
    <script>
        ...
        info.update = function(props) {
            ...
            this._div.innerHTML = '<h4>Informasi Kabupaten/Kota</h4>' +
                ...
                value.toLocaleString('id-ID') + ' jiwa';
        };
        ...
        legend.onAdd = function(map) {
            ...
            div.innerHTML += `<i style="background:#4a148c"></i>` +
