    ...
    <div class="container mt-4 mb-4">
        <div class="bg-white rounded shadow-lg overflow-hidden">
            ...
            <div class="p-4 text-center pb-0">
                <h1 class="text-2xl font-bold text-success">Peta Persebaran Taman Sulawesi Tengah</h1>
                <p class="text-green-100 mt-2">Visualisasi jumlah taman per kabupaten/kota di Sulawesi Tengah</p>
            </div>
    ...
    <script>
        ...
        info.update = function(props) {
            ...
            this._div.innerHTML = '<h4>Informasi Kabupaten/Kota</h4>' +
                ...
                'Jumlah Taman: ' + value.toLocaleString('id-ID') + ' unit';
        };
        ...
        legend.onAdd = function(map) {
            ...
            div.innerHTML = '<h4>Jumlah Taman</h4>';
            ...
            div.innerHTML += `<i style="background:#2e7d32"></i>` +
