    ...
    <div class="container mt-4 mb-4">
        <div class="bg-white rounded shadow-lg overflow-hidden">
            ...
            <div class="p-4 pb-0 text-center">
                <h1 class="text-2xl font-bold text-warning">Peta Persebaran Sekolah Sulawesi Tengah</h1>
                <p class="text-yellow-100 mt-2">Visualisasi jumlah sekolah per kabupaten/kota di Sulawesi Tengah</p>
            </div>
...
@push('scripts')
    <script>
        ...
        function getColor(d) {
            // Warna untuk jumlah sekolah
            const colors = ['#fff59d', '#fff176', '#ffee58', '#ffeb3b', '#fdd835'];
        ...
        info.update = function(props) {
            ...
            this._div.innerHTML = '<h4>Informasi Kabupaten/Kota</h4>' +
                ...
                'Jumlah Sekolah: ' + value.toLocaleString('id-ID') + ' unit';
        };
        ...
        legend.onAdd = function(map) {
            ...
            div.innerHTML += `<i style="background:#f9a825"></i>` +
