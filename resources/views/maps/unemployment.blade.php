    ...
    <div class="container mt-4 mb-4">
        <div class="bg-white rounded shadow-lg overflow-hidden">
            ...
            <div class="p-4 pb-0 text-center">
                <h1 class="text-2xl font-bold text-primary">Peta Tingkat Pengangguran Sulawesi Tengah</h1>
                <p class="text-blue-100 mt-2">Visualisasi tingkat pengangguran per kabupaten/kota di Sulawesi Tengah</p>
            </div>
...
@push('scripts')
    <script>
        ...
        function getColor(d) {
            // Warna untuk tingkat pengangguran
        ...
        info.update = function(props) {
            ...
            this._div.innerHTML = '<h4>Informasi Kabupaten/Kota</h4>' +
                ...
                'Tingkat Pengangguran: ' + value.toLocaleString('id-ID') + '%';
        };
        ...
        legend.onAdd = function(map) {
            ...
            div.innerHTML += `<i style="background:#1565c0"></i>` +
